...
const pluginList = [
    {
        pluginName: __( "BlossomThemes Toolkit",'coachpress-lite' ),
        description: __("BlossomThemes Toolkit provides you necessary widgets for better and effective blogging.", "coachpress-lite"),
        slug: "blossomthemes-toolkit"
    },
    {
        pluginName: __( "BlossomThemes Email Newsletter",'coachpress-lite' ),
        description: __("Easily add email subscription form to your website using shortcode and widget.", "coachpress-lite"),
        slug: "blossomthemes-email-newsletter"
    },
    {
        pluginName: __( "Smash Balloon Social Photo Feed",'coachpress-lite' ),
        description: __("Formerly 'Instagram Feed'. Display clean, customizable, and responsive Instagram feeds from multiple accounts. Supports Instagram oEmbeds.", "coachpress-lite"),
        slug: "instagram-feed"
    },
    {
        pluginName: __( "Regenerate Thumbnails",'coachpress-lite' ),
        description: __("Regenerate the thumbnails for one or more of your image uploads. Useful when changing their sizes or your theme.", "coachpress-lite"),
        slug: "regenerate-thumbnails"
    },
    {
        pluginName: __( "Elementor Website Builder",'coachpress-lite' ),
        description: __("Elementor, the leading WordPress website builder,empowers you to build professional, pixel-perfect websites", "coachpress-lite"),
        slug: "elementor"
    },
    {
        pluginName: __( "Wheel of Life",'coachpress-lite' ),
        description: __("Powerful Tool for Coaches to Generate Leads and Grow Coaching Business", "coachpress-lite"),
        slug: "wheel-of-life"
    }
];
